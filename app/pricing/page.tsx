...
const ultraFeatures = [
    ...
    { en: "Full Qure AI medical assistant", ar: "المساعد الطبي الذكي Qure AI بلا قيود" },
...
const comparisonRows = [
    ...
    { en: "Qure AI medical assistant chat", ar: "المساعد الطبي الذكي Qure AI",     free: false,         ultra: true                },
...
const faqs = [
    {
        ...
        a: { en: "The free plan grants 30 credits monthly for basic OCR analysis. ULTRA is recommended for continuous family scanning, Qure AI chat, and comprehensive safety checks.", ar: "تمنحك الخطة المجانية 30 رصيداً شهرياً للفحص الأساسي. باقة ألترا هي الخيار المثالي إذا كنت ترغب في محادثات Qure AI غير المحدودة، ملفات الأسرة، والتقارير الاحترافية." },
    },
    {
                ...
                <section className="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
                    <div>
                        ...
                        <p className="mt-3 sm:mt-4 text-xs sm:text-sm lg:text-base leading-relaxed text-slate-300 max-w-xl">
                            {t(
                                "Start with core medication analysis for free. Upgrade to ULTRA when you want personal safety context, family profiles, Qure AI chat, and clinical PDF exports.",
                                "ابدأ بفحص الأدوية مجاناً مع ٣٠ رصيد شهرياً. قم بالترقية إلى ULTRA للوصول الكامل لمساعد Qure AI الطبي، ملفات الأسرة، وسياق الأمان المتقدم."
                            )}
                        </p>
                    </div>

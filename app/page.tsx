    ...
    const billboardSlides: BillboardSlide[] = [
        {
            ...
            alt: "Qure AI – scan any medication",
            badge: "QURE AI",
            title: "Pharmaceutical Intelligence, Reimagined",
            subtitle: "Scan. Verify (FDA/Web). Analyze. Export.",
            href: "/scan",
        },
        {
            src: "/billboard/slide-2.svg",
            alt: "FDA + web verification",
            badge: "Trusted sources",
            title: "FDA + Web Cross‑Check",
            subtitle: "More accurate names, manufacturers, and classification.",
            href: "/scan",
        },
        {
            src: "/billboard/slide-3.svg",
            alt: "Report-style results and exports",
            badge: "UX Upgrade",
            title: "Report‑Style Results",
            subtitle: "Mobile‑first layout + high‑quality exports.",
            href: "/scan",
        },
    ];

    return (
        <main className="flex min-h-screen flex-col items-center justify-start pt-24 pb-16 px-4 sm:px-6 md:px-24 relative overflow-hidden">
            ...
            >
                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 w-full justify-center mt-10">
                    <Link href="/scan">

        ...
        <main className="min-h-screen pt-16 sm:pt-24 pb-16 sm:pb-20 px-3 sm:px-6 lg:px-8 max-w-5xl mx-auto select-none" dir={isArabic ? "rtl" : "ltr"}>
            ...
            <div className="text-center space-y-4 mb-12">
                ...
                <p className="text-sm sm:text-base text-slate-400 max-w-xl mx-auto leading-relaxed">
                    {t(
                        "Real-time platform release notes and intelligent feature updates summarized by Qure AI.",
                        "سجل الإصدارات والتحسينات المباشرة للمنصة الموثق والملخص بواسطة الذكاء الاصطناعي Qure AI."
                    )}
                </p>
